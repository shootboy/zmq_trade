...
"""
@Author: ShotBoy
@File: ws_api_socket.py
@Time: 2019/12/18 15:32
...
class WebsocketApiClient(ApiSocket):
    ...
    def connect(self, url,
        ...
        """
        Log.info(self.__class__.__name__, "Connecting to socket <%s>..." % self.id)
    ...
    def __on_error(self, ws, error):
        Log.info(self.__class__.__name__, "Socket <%s> error:\n %s" % (self.id, error))
